...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers=4, dropout_p=0.4, weights=None):
...
class AttnDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, device, num_layers=4, dropout_p=0.4, weights=None):
